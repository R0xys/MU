  ...
  return (
    <main onMouseMove={nandleMousMove} style={{'backgroundPosition' : bgPosition}} className="bg-[#FFE6E6] flex h-screen justify-between overflow-hidden px-6 bg-pink-paws">
      <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{ duration: 0.5 }}>
        <Swiper autoplay={{ delay: 5500, disableOnInteraction: false, pauseOnMouseEnter: true,}} slidesPerView={3} modules={[Mousewheel, Autoplay]} mousewheel={true} loop={true}  direction={'vertical'} className="border-l-emerald-50 overflow-visible rotate-12 ml-80 flex flex-col w-[320px] h-[120%] translate-y-[-100px]">
          <SwiperSlide className="bg-fly-heart bg-[right_bottom_-82px] bg-no-repeat flex flex-col items-center w-[300px] h-[350px] hover:scale-105 transition-transform rounded-3xl backdrop-blur-[3px] border-[1px] shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] p-8 border-[rgba(255,255,255,0.18)] bg-[rgba(190,24,93,0.3)] m-3">
            <h2 className='mb-9 text-3xl'>Одно сообщение - столько эмоций</h2>
          </SwiperSlide>
          <SwiperSlide className="bg-hearts bg-[length:256px_256px] bg-[right_bottom_-62px] bg-no-repeat w-[300px] h-[350px] hover:scale-105 transition-transform rounded-3xl backdrop-blur-[3px] border-[1px] shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] p-8 border-[rgba(255,255,255,0.18)] bg-[rgba(190,24,93,0.3)] m-3">
            <h2 className='mb-9 text-3xl'>Дарите любовь своим близким</h2>
          </SwiperSlide>
          <SwiperSlide className="bg-security bg-[length:256px_256px] bg-[right_bottom_-28px] bg-no-repeat w-[300px] h-[350px] hover:scale-105 transition-transform rounded-3xl backdrop-blur-[3px] border-[1px] shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] p-8 border-[rgba(255,255,255,0.18)] bg-[rgba(190,24,93,0.3)] m-3">
            <h2 className='mb-9 text-3xl'>Ваши секреты останутся только вашими</h2>
          </SwiperSlide>
          <SwiperSlide className="bg-family bg-[length:256px_256px] bg-[right_bottom_-45px] bg-no-repeat w-[300px] h-[350px] hover:scale-105 transition-transform rounded-3xl backdrop-blur-[3px] border-[1px] shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] p-8 border-[rgba(255,255,255,0.18)] bg-[rgba(190,24,93,0.3)] m-3">
            <h2 className='mb-9 text-3xl'>Один мессенджер для всей семьи</h2>
          </SwiperSlide>
        </Swiper>
      </motion.div>
      <div className='w-96 flex flex-grow justify-center items-center flex-col mr-28 ml-24'>
        ...
        <Image alt='cat lie on my' src={myLogo} />
        <form action="#" method='post' className=' w-96 flex flex-col items-center gap-y-4'>
          <PhoneInput inputClass='w-full border-[#ec4899] border-4 backdrop-blur-[3px] rounded-2xl placeholder:text-[#ec489a67] text-[#ec4899] bg-[rgba(190,24,93,0.12)] px-4 py-3 outline-none' />
          <input placeholder='Номер телефона' type="tel" className='w-full border-[#ec4899] border-4 backdrop-blur-[3px] rounded-2xl placeholder:text-[#ec489a67] text-[#ec4899] bg-[rgba(190,24,93,0.12)] px-4 py-3 outline-none' />
          <button type='submit' className='w-full border-[#ec4899] border-4 rounded-2xl text-[#f9a8d4] bg-[#be185d] hover:bg-[#b11657] transition mt-7 px-4 py-3 outline-none'>Войти</button>
        </form>
